...
TypeScript code intelligence CLI with AST and LSP subcommands.

This is the standalone source repo for the `code-intel-ts` Bun CLI. Nix packaging lives separately in `nixpkg-code-intel-ts`.
